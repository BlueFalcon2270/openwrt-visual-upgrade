...
```bash
wget -O openwrt-upgrade.sh https://raw.githubusercontent.com/BlueFalcon2270/openwrt-visual-upgrade/main/openwrt-upgrade.sh && chmod +x openwrt-upgrade.sh && ./openwrt-upgrade.sh
```
<br><br>
